...
public class Tag implements CommandExecutor
{
    public boolean onCommand(final CommandSender sender, final Command cmd, final String label, final String[] args) {
        ...
        if (args.length != 0) {
            if (args[0].equalsIgnoreCase("dono")) {
                if (p.hasPermission("tag.dono")) {
                    ...
                    p.sendMessage(String.valueOf(String.valueOf(API.preffix)) + "§aSua tag foi modificada conforme o pedido para §fDono.");
                    return true;
                }
            ...
            if (args[0].equalsIgnoreCase("dev")) {
                if (p.getName().equalsIgnoreCase("NinhoBACK")) {
                    ...
                    p.setPlayerListName("§4" + p.getName());
                    p.sendMessage(String.valueOf(String.valueOf(API.preffix)) + "§aSua tag foi modificada conforme o pedido para §fdeveloper.");
                    return true;
                }
            ...
            if (args[0].equalsIgnoreCase("admin")) {
                if (p.hasPermission("tag.admin")) {
                    ...
                    p.sendMessage(String.valueOf(String.valueOf(API.preffix)) + "§aSua tag foi modificada conforme o pedido para §fadmin.");
                    return true;
                }
                p.sendMessage(API.naotemtag);
            }
            ...
            if (args[0].equalsIgnoreCase("mod")) {
                if (p.hasPermission("tag.mod")) {
                    ...
                    p.sendMessage(String.valueOf(String.valueOf(API.preffix)) + "§aSua tag foi modificada conforme o pedido para §fmod.");
                    return true;
                }
                p.sendMessage(API.naotemtag);
            }
            ...
            if (args[0].equalsIgnoreCase("trial")) {
                if (p.hasPermission("tag.trial")) {
                    ...
                    p.sendMessage(String.valueOf(String.valueOf(API.preffix)) + "§aSua tag foi modificada conforme o pedido para §ftrial.");
                    return true;
                }
                p.sendMessage(API.naotemtag);
            }
            if (args[0].equalsIgnoreCase("helper")) {
                if (p.hasPermission("tag.helper")) {
                    ...
                    p.setPlayerListName("§d" + p.getName());
                    p.sendMessage(String.valueOf(String.valueOf(API.preffix)) + "§aSua tag foi modificada conforme o pedido para §fhelper.");
                    return true;
                }
                p.sendMessage(API.naotemtag);
            }
            if (args[0].equalsIgnoreCase("builder")) {
                if (p.hasPermission("tag.builder")) {
                    ...
                    p.sendMessage(String.valueOf(String.valueOf(API.preffix)) + "§aSua tag foi modificada conforme o pedido para §fbuilder.");
                    return true;
                }
                p.sendMessage(API.naotemtag);
            }
            if (args[0].equalsIgnoreCase("youtuber")) {
                if (p.hasPermission("tag.youtuber")) {
                    ...
                    p.sendMessage(String.valueOf(String.valueOf(API.preffix)) + "§aSua tag foi modificada conforme o pedido para §fyoutuber");
                    return true;
                }
                p.sendMessage(API.naotemtag);
            }
            if (args[0].equalsIgnoreCase("youtuber+")) {
                if (p.hasPermission("tag.youtuber+")) {
                    TagsAPI.setarTag(p, "§b§lYT+ §b");
                    p.setPlayerListName("§b" + p.getName());
                    p.sendMessage(String.valueOf(String.valueOf(API.preffix)) + "§aSua tag foi modificada conforme o pedido para §fyoutuberplus.");
                    return true;
                }
                p.sendMessage(API.naotemtag);
            }
            if (args[0].equalsIgnoreCase("pro")) {
                if (p.hasPermission("tag.pro")) {
                    ...
                    p.sendMessage(String.valueOf(String.valueOf(API.preffix)) + "§aSua tag foi modificada conforme o pedido para §fpro.");
                    return true;
                }
                p.sendMessage(API.naotemtag);
            }
            if (args[0].equalsIgnoreCase("vip")) {
                if (p.hasPermission("tag.vip")) {
                    ...
                    p.sendMessage(String.valueOf(String.valueOf(API.preffix)) + "§aSua tag foi modificada conforme o pedido para §fvip.");
                    return true;
                }
                p.sendMessage(API.naotemtag);
            }
            if (args[0].equalsIgnoreCase("mvp")) {
                if (p.hasPermission("tag.mvp")) {
                    ...
                    p.sendMessage(String.valueOf(String.valueOf(API.preffix)) + "§aSua tag foi modificada conforme o pedido para §fmvp.");
                    return true;
                }
                p.sendMessage(API.naotemtag);
            }
            if (args[0].equalsIgnoreCase("beta")) {
                if (p.hasPermission("tag.beta")) {
                    ...
                    p.sendMessage(String.valueOf(String.valueOf(API.preffix)) + "§aSua tag foi modificada conforme o pedido para §fbeta.");
                    return true;
                }
                p.sendMessage(API.naotemtag);
            }
            if (args[0].equalsIgnoreCase("normal")) {
                if (p.hasPermission("tag.normal")) {
                    ...
                    p.sendMessage(String.valueOf(String.valueOf(API.preffix)) + "§aSua tag foi modificada conforme o pedido para §fmembro.");
                    return true;
                }
                p.sendMessage(API.naotemtag);
            }
        ...
        if (p.hasPermission("tag.dono")) {
            p.sendMessage("§aUse: §f/tag §4DONO, DEV, §4ADMIN+, §cADMIN, §5§oMOD+, §5MOD, §dTRIAL, §d§oHELPER, §bYOUTUBER, §b§oYOUTUBER+, §eBUILDER, §1BETA, §6PRO, §9MVP, §aVIP, §7NORMAL");
            return true;
        }
        if (p.hasPermission("tag.admin")) {
